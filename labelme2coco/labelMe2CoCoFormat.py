...
labelme_json_train = glob.glob('dataset/ori/train/*.json')
labelme2coco(labelme_json_train, 'dataset/new/train/annotations.json')

labelme_json_val = glob.glob('dataset/ori/val/*.json')
labelme2coco(labelme_json_val, 'dataset/new/val/annotations.json')

# pic_train = glob.glob('dataset/ori/train/*.jpg')
# pic_val = glob.glob('dataset/ori/val/*.jpg')
#
# for i in pic_train:
#     shutil.copy(i,)